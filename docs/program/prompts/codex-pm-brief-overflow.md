...
## Trigger
Schedule — 8:00am ET daily via Codex Automation (backup for Claude Code Routine).
...
[TODAY'S DATE]". If one exists, stop — do not post anything.

Step 2 — If no brief exists for today, read reports/pm-packet.json and post a GitHub
issue with:
