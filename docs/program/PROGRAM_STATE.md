...
| HD/WMT/NKE/DIS source manifests repaired | Resolved | All four companies repaired: Codex re-researched, Claude Code validated and promoted to `company-packs/` on `feat/blue-chip-source-manifests`. All 68 quarters now use official IR-domain sources. PR #18 ready to merge. |
